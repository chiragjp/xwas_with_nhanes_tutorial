...
- How would you interpret each estimate? 
...
2. When increasing the numbner of variables, how would the pvalue threshold change to accomodate more tests? How would the FDR change, if at all?
3. Execute the XWAS in another phenotype. What are the similarties and differences between your analysis in 1.
4. How much variance explained in telomeres do the top factors explain? Is this to be expected?
5. Implement the XWAS without using the `for` operator using the tidyverse suite of commands.
